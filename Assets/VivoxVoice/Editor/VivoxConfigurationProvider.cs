...
namespace Unity.Services.Vivox.Editor
{
    ...
    class VivoxConfigurationProvider : IConfigurationProvider
    {
        ...
        public void OnBuildingConfiguration(ConfigurationBuilder builder)
        {
            ...
            {
                builder.SetString(VivoxServiceInternal.k_TokenKey, "");
            }
            builder.SetString(VivoxServiceInternal.k_ServerKey, VivoxSettings.Instance.Server);
            builder.SetString(VivoxServiceInternal.k_DomainKey, VivoxSettings.Instance.Domain);
            builder.SetString(VivoxServiceInternal.k_IssuerKey, VivoxSettings.Instance.TokenIssuer);
